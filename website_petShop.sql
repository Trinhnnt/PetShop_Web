...
(1, N'Thức ăn khô cho mèo con', N'https://www.petmart.vn/wp-content/uploads/2021/06/thuc-an-cho-cho-truong-thanh-co-nho-royal-canin-mini-adult2.jpg', 1, 1, N'Thức ăn cho thú cưng', N'Royal Canin', 198000, 0, 67, N'Nâu', 4.5, N'Mọi lứa tuổi', N'Đức', N'49x36x10 cm', N'Thịt bò tươi, gạo, vitamin tổng hợp', N'Thức ăn cao cấp cho mèo con', N'Định lượng theo cân nặng'),
(2, N'Snack cho mèo con', N'https://www.pedigree.com.vn/cdn-cgi/image/format=auto,q=90/sites/g/files/fnmzdf3531/files/2024-11/6914973309708-product-image-1.png', 1, 2, N'Thức ăn cho thú cưng', N'SmartHeat', 66000, 55000, 59, N'N', 4.8, N'Trên 3 tháng', N'Hàn Quốc', N'45x40x35 cm', N'Ngũ cốc nguyên hạt, thịt cá hồi, chất xơ', N'Thức ăn đặc biệt cho mèo con', N'Cho ăn 2 lần/ngày'),
