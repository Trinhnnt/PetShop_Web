...
namespace Web_projectframeword_admin.Models
{
    public class HoaDon
    {
        ...
        public HoaDon(int maHD, KhachHang kH, KhuyenMai kM, string tenKH, int tongTienTT, string diaChiGH, DateTime ngayLapHD, int tinhTrangTT, int tinhTrangHD, int soTienNhan, int soTienTra, int maKH, int maKM)
        {
            MaHD = maHD;
            KH = kH;
            KM = kM;
