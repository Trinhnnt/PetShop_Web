...
namespace Web_ProjectFrameWork.Controllers
{
    public class TaiKhoanController : Controller
    {
        ...
        public IActionResult CapNhatTK(KhachHang kh)
        {
            ...
            System.Diagnostics.Debug.WriteLine("GioiTinh trước khi cập nhật: " + kh.GioiTinh);
            System.Diagnostics.Debug.WriteLine("MaKH: " + kh.MaKH);
            ...
            System.Diagnostics.Debug.WriteLine("Kết quả cập nhật: " + count + " dòng bị ảnh hưởng");

            HttpContext.Session.Remove("KH");

            // Sử dụng MaKH thay vì Email
            var khcontext = context.GetKhachHang(kh.MaKH);

            // Log giá trị sau khi lấy lại từ database
            if (khcontext != null)
            {
                System.Diagnostics.Debug.WriteLine("GioiTinh sau khi lấy lại: " + khcontext.GioiTinh);
            }
